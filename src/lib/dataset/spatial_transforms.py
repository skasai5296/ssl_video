...
class ColorJitter_Nonconsistent:
    """Randomly change the brightness, contrast and saturation of an image. --modified
    ...
    Args:
        ...
        saturation (float or tuple of float (min, max)): How much to jitter saturation.
            ...
            1 + saturation] or the given [min, max]. Should be non negative numbers.
